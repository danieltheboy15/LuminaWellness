import { Instagram, ShoppingBag, Mail, Sparkles } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    <footer
      id="brand-footer"
      className="bg-white border-t border-zinc-200/80 py-16 px-4 sm:px-6 lg:px-8 text-center sm:text-left relative overflow-hidden"
    >
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-[#dfabeb]/10 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-12 relative z-10">
        ...
        <div className="space-y-4 max-w-sm text-center sm:text-left">
          ...
          <p className="text-zinc-650 text-xs sm:text-sm font-light leading-relaxed">
            Lumina Wellness — weight-loss treatments, made affordable for Nigerians.
          </p>
        </div>

        {/* Links Right Column */}
        <div className="space-y-6 text-center sm:text-left">
          <h4 className="text-xs font-mono font-bold text-zinc-500 tracking-widest uppercase">Quick Channels</h4>
          ...
          <div className="flex flex-wrap justify-center sm:justify-start items-center gap-6">
            ...
            >
              <ShoppingBag className="w-4 h-4 text-[#8a4a99]" />
              <span>Lumina Shop</span>
            </a>
            ...
            >
              ...
              <span>luminiawellnessng@gmail.com</span>
            </a>
          </div>
        </div>
      ...
      {/* Disclaimer Section */}
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-6 text-zinc-550 text-[10px] sm:text-xs font-light leading-relaxed relative z-10">
        <p className="max-w-2xl text-zinc-550 text-center sm:text-left">
